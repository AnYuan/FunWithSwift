    ...
    subscript (i: DateIndex) -> UIImage? {
        ...
        set {
            if let value = newValue {
                ...
                if i == startIndex {
                    if let newStartDate = storage.keys.sorted(isOrderedBefore: dateIsOrderedBefore).first {
                    ...
                    if let newEndDate = storage.keys.sorted(isOrderedBefore: dateIsOrderedBefore).last {
