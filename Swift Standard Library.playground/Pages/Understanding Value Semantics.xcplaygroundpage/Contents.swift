...
/*:
The `sortedList(_:)` function uses the `sort(isOrderedBefore:)` method to sort the ingredients in place. You'll learn more about sorting in [Processing Sequences and Collections](Processing%20Sequences%20and%20Collections).
*/
